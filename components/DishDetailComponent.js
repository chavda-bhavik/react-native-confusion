...
import { View, Text, ScrollView, FlatList, StyleSheet, Alert,PanResponder } from "react-native";
...
const RenderDish = (props) => {
    ...
    if(dish)
        return <Animatable.View animation="fadeInDown" duration={2000} delay={1000} {...panResponder.panHandlers} >
            <Card
